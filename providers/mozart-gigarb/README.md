...
Autonomous mode: when `gigs[]` is not provided, GigArb fetches live jobs via a RapidAPI endpoint and runs ranking automatically, with deterministic fallback gigs if upstream sources fail.
