"""
Numinous SN6 miner agent v10.

Design goals:
- Prioritize reliability under 240s sandbox constraints.
- Use proxy-only network access (validator gateway compatible).
- Lean harder on market anchors for high-similarity matches.
- Keep calibration conservative and avoid invalid outputs.
"""
...
TIME_BUDGET_SECONDS = 190.0
PRED_MIN = 0.02
PRED_MAX = 0.98
BASE_FALLBACK = 0.42

# Phase-specific runtime caps to reduce timeout risk.
CRAWL_TIMEOUT_CAP = 16.0
OPENAI_TIMEOUT_CAP = 60.0
CHUTES_TIMEOUT_CAP = 32.0

MIN_SIM_FOR_MARKET_LOCK = 0.86
MIN_SIM_FOR_BLEND = 0.72
